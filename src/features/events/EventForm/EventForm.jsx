...
class EventForm extends Component {
  ...
  onFormSubmit = values => {
    if(this.props.intitialValues.id) {
      this.props.updateEvent(values);
      this.props.history.push(`/events/${this.props.intitialValues.id}`);
    } else {
      const newEvent = {
        ...values,
        id: cuid(),
  ...
  render() {
    const {history, intitialValues, invalid, submitting, pristine} = this.props;
    return (
      <Grid>
        ...
        <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)} autoComplete="off">
          ...
          <Button onClick={intitialValues.id ? () => history.push(`/events/${intitialValues.id}`)
